...
public abstract class CustomTileService extends TileService {
     ...
     *
     * Changing the icon from here also allows to set an initial icon that differs from the
     * one defined in the manifest and that we don't constantly update on every onStartListening()
     * call.
     */
    @Override
